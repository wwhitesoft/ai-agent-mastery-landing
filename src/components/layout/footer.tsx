      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">AI Agent Mastery</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              La tua accademia per imparare a creare agenti AI professionali. 
              Trasforma la tua carriera con le competenze del futuro.
            </p>
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-gray-400">
                <Mail className="h-4 w-4" />
                <span>info@aiagentmastery.it</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 AI Agent Mastery. Tutti i diritti riservati.
          </p>
